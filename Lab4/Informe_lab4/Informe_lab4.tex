...
\section{Desarrollo}
    ...
    \subsection{Implementación en FPGA}
        ...
        \begin{itemize}
            \item o\_sample\_I(probe0\_0): Representa la salida del filtro en Fase.
            \item o\_sample\_Q(probe1\_0): Representa la salida del filtro en Cuadratura.
            \item o\_led(probe2\_0): Representa a los leds que muestran el estado actual de i\_sw.
            \item o\_err\_I(probe3\_0): Representa el BER para Fase.
            \item o\_err\_Q(probe5\_0): Representa el BER para Cuadratura.
            \item o\_ber\_ok(probe7\_0): Led que se enciende al tener BER igual a 0.
        \end{itemize}
